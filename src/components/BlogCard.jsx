  ...
  return (
    <div className="container mx-auto p-3">
      <div className="flex flex-wrap gap-4">
        <div className="w-full mx-auto relative block overflow-hidden rounded-lg shadow-lg p-4 sm:p-4 lg:p-6  border border-gray-200 transition-transform transform hover:scale-105">
